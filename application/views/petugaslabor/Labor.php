    ...
    <div class="modal-content animated fadeIn">
        ...
        <div class="modal-body" id="modal-body">              
          <form role="form" id="hasil_form" onsubmit="return false;" type="multipart">
            ...
            <input type="hidden"  id="" name="tahap" value="4">
            <div class="form-group">
            <label for="negara">Nomor Sampel</label> 
       
            <input readonly type="text" class="form-control" id="no_sampel" name="no_sampel" required="required" >
             
            </div>
            <div class="form-group">
            <label for="negara">Hasil Laboratorium </label>     
            <input type="text" class="form-control" id="hasil_labor" name="hasil_labor" required="required" >
            </div>
            <!-- <div class="form-group">
...
$(document).ready(function() {
  ...
  var requestModal = {
    ...
    hasil_labor: $('#request_modal').find('#hasil_labor'),
  ...
  var hasilModal = {
    ...
    hasil_labor: $('#hasil_modal').find('#hasil_labor'),
  ...
  function getAllSampel(){
    return $.ajax({
      ...
      data: {instansi : id_instansi, tahap: '3'},
...
function convStatus(status,hasil){
  ...
  function renderSampel(data){
    ...
    //   var photo = sampel['photo_tim'] ? `<img src="<?=base_url('uploads/photo/')?>${sampel['photo_tim']}" class="img-sm">` : 'Tidak Ada';
      renderData.push([sampel['jenis'], sampel['no_sampel'],sampel['tanggal_pengambilan_sampel'],hasilButton]);
    });
  ...
  FDataTable.on('click','.hasil', function(){
    ...
    hasilModal.hasil_labor.val(cur['hasil_labor']);
