  ...
  <div class="col-lg-12">
    ...
    <div class="col-lg-6">
      <div class="ibox">
        <div class="ibox-content">
            <h5>ID BDT</h5>
            <p class="no-margins"><span id="IDUMKM">-</span></p>
        </div>
      </div>
    </div>
    <div class="col-lg-6">
    ...
    <div class="modal-content animated fadeIn">
        ...
        <div class="modal-body" id="modal-body">              
          <form role="form" id="informasi_form" onsubmit="return false;" type="multipart">
            <!-- <input type="hidden" id="IDUMKM" name="IDUMKM"> -->
            <input type="hidden"  id="IDUMKM_edit" name="IDUMKM">
            <div class="form-group">
...
$(document).ready(function() {
  ...
  var IDUMKM = `<?=$contentData['IDUMKM']?>`;

 
  var info = {
    'self': $('#info_container'),
    'jenis_bantuan': $('#info_container').find('#jenis_bantuan'),
    'IDUMKM': $('#info_container').find('#IDUMKM'),
  ...
  if(sessionData['id_role'] != 6){
    ...
    $('#edit_bantuan').on('click', function(){
        ...
        informasiModal.IDUMKM_edit.val(dataInfo['IDUMKM']);
  ...
  function getInfo(){
    return $.ajax({
        url: `<?php echo site_url('DTKSController/getAllUMKM_v2/')?>`, 'type': 'GET',
       data : {IDUMKM: IDUMKM},
  ...
  function renderInfo(){
    ...
    info.IDUMKM.html(`${dataInfo['IDUMKM']}`);
  ...
  info.add_tim_btn.on('click', function(){
    ...
    timModal.IDUMKM.val(dataInfo['IDUMKM']);
  });
  
  info.edit_info_btn.on('click', function(){
    informasiModal.self.modal('show');
    informasiModal.IDUMKM.val(dataInfo['IDUMKM']);
