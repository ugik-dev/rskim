            ...
            <table id="FDataTable" class="table table-bordered table-hover" style="padding:0px">
              <thead>
                <tr>
                  ...
                  <th style="width: 24%; text-align:center!important">OPD</th>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content animated fadeIn">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Kelola User OPD</h4>
      ...
      <div class="modal-body" id="modal-body">              
        <form opd="form" id="user_form" onsubmit="return false;" type="multipart" autocomplete="off">
          ...
          <div class="form-group">
            <label for="judul">OPD</label> 
            <select class="form-control mr-sm-2" name="id_opd" id="opd"></select>
          </div>
          <div id="photo"></div>
...
$(document).ready(function() {
  ...
  $.when(getAllRole(), getAllOPD(), getAllUser()).then((e) =>{
  ...
  function renderOPDSelectionFilter(data){
    ...
    toolbar.id_opd.append($('<option>', { value: "", text: "-- Semua OPD --"}));
    toolbar.id_opd.append($('<option>', { value: -1, text: "-- Tingkat Provinsi --"}));
    Object.values(data).forEach((d) => {
  ...
  function renderUser(data){
    ...
    Object.values(data).forEach((user) => {
      ...
      `;
      renderData.push([user['id_user'], user['username'], user['nama'], user['title_role'], user['nama_opd'] ? user['nama_opd'] : 'Bukan Tingkat OPD', button]);
    });
