  ...
  <div class="ibox ssection-container">
    <div class="ibox-content">
      <form class="form-inline" id="toolbar_form" onsubmit="return false;">
        ...
        <!-- <input type="hidden" id="sta_pkh" name="sta_pkh" value="">
        <input type="hidden" id="sta_rastra" name="sta_rastra" value=""> -->
            ...
            <table id="FDataTable" class="table table-bordered table-hover" style="padding:0px">
              <thead>
                <tr>
                  ...
                  <th style="width: 24%; text-align:center!important">PKH</th>
                  <th style="width: 16%; text-align:center!important">BNPT</th>
    ...
    <div class="modal-content animated fadeIn">
        ...
        <div class="modal-body" id="modal-body">              
          <form role="form" id="informasi_form" onsubmit="return false;" type="multipart">
            ...
            <input type=""  id="IDUMKM_edit" name="IDUMKM">
            <input type=""  id="IDBDT_edit" name="IDBDT">
...
$(document).ready(function() {
  ...
  var informasiModal = {
    ...
    form: $('#informasi_form'),
    IDUMKM_edit: $('#informasi_modal').find('#IDUMKM_edit'),
  ...
  informasiModal.form.on('submit', (ev) => {
    ...
    $.ajax({
      url: "<?=site_url('DTKSController/editUMKM/')?>",
      type: "POST",
      ...
      success: (data) => {
        ...
        dataInfo = json['data'];
        dataUser[dataInfo['IDUMKM']] = dataInfo;
        renderUser(dataUser);
  ...
  function getAllData(){
    ...
    swal.showLoading();
    return $.ajax({
      url: `<?php echo site_url('DTKSController/getAllUMKM/')?>`, 'type': 'GET',
      data: toolbar.form.serialize(),
      success: function (data){
  ...
  function renderUser(data){
    ...
    Object.values(data).forEach((user) => {
      var editButton = `
        <a class="edit dropdown-item" data-id='${user['IDUMKM']}'><i class='fa fa-pencil'></i> Edit User</a>
      `;
      var deleteButton = `
        <a class="delete dropdown-item" data-id='${user['IDUMKM']}'><i class='fa fa-trash'></i> Hapus User</a>
      `;
      var downloadButton = `<a href="<?=site_url("PdfController/getPDF/")?>?IDUMKM=${user['IDUMKM']}" class="dropdown-item"><i class='fa fa-pencil'></i> Download PDF File </a>`;
     
      var detailButton = `<a href="<?=site_url("AdminController/PageInfoBantuanUMKM/")?>?IDUMKM=${user['IDUMKM']}" class="dropdown-item"><i class='fa fa-pencil'></i> Detail Info </a>`;
      ...
      `;
      renderData.push([user['NIK'], user['NAMA_UMKM'], user['ALAMAT'], user['sta_pkh'] == '1' ? 'ADA' : '', user['sta_rastra'] == '3' ? 'ADA' : '',  colorBantuan(user['jenis_bantuan']), button]);
    });
  ...
  function getSearch(){
    return $.ajax({
      url: `<?php echo site_url('TerdampakController/getAllDataUMKM/')?>`, 'type': 'GET',
  ...
  FDataTable.on('click', '.edit', function(){
    informasiModal.IDUMKM_edit.val(null);
    ...
    informasiModal.IDUMKM_edit.val(currentData['IDUMKM']);
