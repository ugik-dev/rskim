class FileUploader{
  constructor(el, currentFile, filename, accept, showLabel = true){
      ...
      <div class="form-group">
        ...
        <div class="input-group">
          ...
          <div class="input-group-append">
            <button class="btn btn-outline-success file-upload-btn" type="button" id="downloadFileButton" style="display:none" data-toggle="tooltip" data-placement="top" title="Unduh"><i class="fa fa-download"></i></button>
            <button class="btn btn-outline-primary file-upload-btn" type="button" id="browseFileButton" data-toggle="tooltip" data-placement="top" title="Pilih ${capFirstLetter(this.filename)} File"><i class="fa fa-folder-open"></i></button>
            <button class="btn btn-outline-danger file-upload-btn" type="button" id="deleteFileButton" style="display:none" data-toggle="tooltip" data-placement="top" title="Hapus ${capFirstLetter(this.filename)} File"><i class="fa fa-trash"></i></button>
